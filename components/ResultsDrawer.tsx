...
export const ResultsDrawer: React.FC<ResultsDrawerProps> = ({
  ...
  return (
    <aside className={`w-full lg:w-[480px] xl:w-[540px] h-full border-l-2 border-black flex flex-col z-20 shadow-[-4px_0px_0px_0px_#000] shrink-0 overflow-hidden transition-colors ${
      ...
      {/* Quick Filter Tabs */}
      <div className={`p-3 border-b-2 border-black flex items-center gap-2 overflow-x-auto no-scrollbar ${
        isLight ? 'bg-slate-100' : 'bg-slate-900/90'
      }`}>
        <button
        ...
        <button
          ...
          className={`px-3 py-1 rounded-xl text-xs font-black shrink-0 transition-all border-2 border-black cursor-pointer flex items-center gap-1 ${
            activeFilter === 'redesign'
              ...
              : isLight
                ? 'bg-white text-[#E11D48] hover:bg-rose-50 shadow-[1.5px_1.5px_0px_0px_#000]'
        ...
        <button
          ...
          className={`px-3 py-1 rounded-xl text-xs font-black shrink-0 transition-all border-2 border-black cursor-pointer flex items-center gap-1 ${
            activeFilter === 'poor_ai_design'
              ...
              : isLight
                ? 'bg-white text-purple-700 hover:bg-purple-50 shadow-[1.5px_1.5px_0px_0px_#000]'
        ...
        <button
          ...
          className={`px-3 py-1 rounded-xl text-xs font-black shrink-0 transition-all border-2 border-black cursor-pointer flex items-center gap-1 ${
            activeFilter === 'no_ssl'
              ...
              : isLight
                ? 'bg-white text-amber-700 hover:bg-amber-50 shadow-[1.5px_1.5px_0px_0px_#000]'
        ...
        <button
          ...
          className={`px-3 py-1 rounded-xl text-xs font-black shrink-0 transition-all border-2 border-black cursor-pointer flex items-center gap-1 ${
            activeFilter === 'high_performing'
              ...
              : isLight
                ? 'bg-white text-emerald-700 hover:bg-emerald-50 shadow-[1.5px_1.5px_0px_0px_#000]'
      ...
      <div className={`p-3 border-b-2 border-black flex flex-wrap items-center justify-between gap-2 ${
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3">
        {filteredBusinesses.length === 0 ? (
          <div className={`text-center py-12 px-4 border-2 border-black rounded-2xl shadow-[4px_4px_0px_0px_#000] ${
            isLight ? 'bg-white text-slate-900' : 'bg-slate-900 text-white'
          }`}>
            <AlertCircle className="w-8 h-8 text-[#FFE600] mx-auto mb-2 stroke-[2.5]" />
            <p className="text-sm font-black text-inherit">NO LEADS FOUND</p>
