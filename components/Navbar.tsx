...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="h-16 border-b-2 border-black bg-slate-950 px-6 flex items-center justify-between sticky top-0 z-40 shadow-[0px_4px_0px_0px_#000]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="font-black text-xl text-white tracking-tight flex items-center gap-1">
            ...
            <p className="text-[11px] font-bold text-slate-400 hidden sm:block">Automated Lead Discovery & Modernization Engine</p>
          </div>
        </div>

        {/* View Switcher Tabs: Map vs CRM Database */}
        <div className="flex items-center bg-slate-900 border-2 border-black p-1 rounded-xl shadow-[2.5px_2.5px_0px_0px_#000]">
          <button
      ...
      {/* Live Status Indicators, User Info & Settings */}
      <div className="hidden md:flex items-center gap-3">
        {activeView === 'map' && leadCount > 0 && (
          <div className="flex items-center gap-3 text-xs bg-slate-900 border-2 border-black px-3.5 py-1.5 rounded-xl shadow-[2.5px_2.5px_0px_0px_#000]">
